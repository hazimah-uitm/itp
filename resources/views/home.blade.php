                    ...
                    <div class="d-flex flex-wrap justify-content-end">
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="month" class="form-select ms-2 rounded" id="monthFilter">
                                <option value="all" {{ request('month') == 'all' ? 'selected' : '' }}>Semua Bulan
                                </option>
                                @for ($m = 1; $m <= 12; $m++)
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="complainent_category" class="form-select ms-2 rounded"
                                id="complainentCategoryFilter">
                                <option value="all"
                                    {{ request('complainent_category', 'all') == 'all' ? 'selected' : '' }}>Semua Kategori
                                    Pengadu</option>
                                @foreach ($complainentCategoryFilter as $category)
                                    <option value="{{ $category }}"
                                        {{ request('complainent_category') == $category ? 'selected' : '' }}>
                                        {{ $category }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="staff_duty" class="form-select ms-2 rounded" id="staffDutyFilter">
                                <option value="all" {{ request('staff_duty', 'all') == 'all' ? 'selected' : '' }}>Semua
                                    PIC</option>
                                @foreach ($staffDutyFilter as $staffDuty)
                                    <option value="{{ $staffDuty }}"
                                        {{ request('staff_duty') == $staffDuty ? 'selected' : '' }}>
                                        {{ $staffDuty }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="category" class="form-select ms-2 rounded" id="categoryFilter">
                                <option value="all" {{ request('category', 'all') == 'all' ? 'selected' : '' }}>Semua
                                    Kategori</option>
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="aduan_category" class="form-select ms-2 rounded" id="aduanCategoryFilter">
                                <option value="all" {{ request('aduan_category', 'all') == 'all' ? 'selected' : '' }}>
                                    Semua Kategori Aduan</option>
                                @foreach ($aduanCategoryFilter as $category)
                                    <option value="{{ $category }}"
                                        {{ request('aduan_category') == $category ? 'selected' : '' }}>
                                        {{ $category }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-2 ms-2 col-12 col-md-auto">
                            <select name="aduan_status" class="form-select ms-2 rounded" id="aduanStatusFilter">
                                <option value="all" {{ request('aduan_status', 'all') == 'all' ? 'selected' : '' }}>
                                    Semua Aduan Status</option>
                                @foreach ($aduanStatusFilter as $aduanStatus)
                                    <option value="{{ $aduanStatus }}"
                                        {{ request('aduan_status') == $aduanStatus ? 'selected' : '' }}>
                                        {{ $aduanStatus }}
                                    </option>
                                @endforeach
                            </select>
                                            ...
                                            @foreach ($allCategories as $categoryData)
                                                <tr>
                                                    ...
                                                    <td style="word-wrap: break-word; white-space: normal;">
                                                        {{ $categoryData['category'] }}</td>
                                                    <td style="word-wrap: break-word; white-space: normal;">
                                                        {{ $categoryData['subcategory'] }}</td>
